        ...
        [
            {
                ...
                challenge: [
                    ...
                    "Client was looking to adopt an AML solution for its banking enterprise to comply with regulatory requirements through unified and consistent watch list screening and at the same time also create value through effective weeding out of fraudulent participants on its network. Some of the other concerns were to have a low maintenance solution, effective with less false alarms to help optimise usage of resources."
                ],
                solution: [
                    "Avows partnered with the client to provide an AML solution that matched their requirements in term of being fully equipped to weed out unnecessary noise, effective screening and at the same time detection of suspicious transactions in real time. Our Anti-Money Laundering solutions comprises of proven methodologies that we use to detect more and more behavioural characteristics to classify risks and threats as authentic.",
                    "Over time, our solution is capable of learning and integrating patterns that emerge out of newer fraudulent ways the scammers or money launderers adopt hence making it increasingly difficult for them to beat the system.",
                ...
                benefit: [
                    "Our solution incorporates modern technologies like AI, ML and robotic automation along with audio/facial recognition and document verification to allow the organisation to manage their compliance 100 percent and predict fraudulent behaviour patterns which reduce unaccounted damages.",
