                                    ...
                                    <Tabs defaultActiveKey="ACP" transition={false} id="noanim-tab-example">
                                        <Tab eventKey="ACP" title="All-in-One Chatbot Platform">
                                            ...
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">Avows helps organisations to build a powerful AI-driven customer
                                        ...
                                        <Tab eventKey="AI" title="AI + Data Science">
                                            ...
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">Our Artificial Intelligence/Machine Learning (AI/ML) service offering 
                                            ...
                                            <p className="p1 text-justify"><br />
                                            <span className="s1">We are focused on the innovations of AI/ML and we work with the experts 
                                        ...
                                        <Tab eventKey="BD" title="Big Data">
                                            ...
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">Our services and concepts cater to cloud-based big data to help our 
                                            ...
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">We help customers to uncover information such as hidden patterns, 
                                            ...
                                            <ul><br />
                                                ...
                                                <p className="p1 text-justify">
                                                    <span className="s1">Avows helps customers to establish a lake as a single source of
                                                ...
                                                <p className="p1 text-justify">
                                                    <span className="s1">Collect and manage data in a single, unified landscape to lower 
                                                    data sprawl, solve complex issues, and simplify application delivery.</span>
                                                </p>
                                                <li><strong>Data Modeling</strong></li>
                                                <p className="p1 text-justify">
                                                    <span className="s1">Discover, refine, enrich, and govern any type or volume of 
                                                ...
                                                <p className="p1 text-justify">
                                                    <span className="s1">Consolidate, sanitize, and reconcile business data - 
                                        ...
                                        <Tab eventKey="ABP" title="Automating Business Process & Beyond">
                                            ...
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">We offer a range of solutions to automate your business processes by various 
                                            ...
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">This results in reduced human error, manual work, process completion times and associated 
                                                costs which gives scalability to business growth with available resources.</span>
                                            </p>
                                            <p className="p1 text-justify"><br />
                                                <span className="s1">With our professional IT team at Avows, we design our state-of-the-art 
